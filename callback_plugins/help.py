...
class CallbackModule(CallbackBase):
    ...
    def print_help_message(self):
        ...
        self._display.display("Contact us: support@sysmon.com", color=C.COLOR_HIGHLIGHT)
        self._display.display("It seems that you encounter some problems. You can send an email to the above email address, attached with the tidb-ansible/inventory.ini and tidb-ansible/log/ansible.log files and the error message, or new issue on https://github.com/zhengwanbo/sysmonitor/issues. We'll try our best to help you deploy a TiDB cluster. Thanks. :-)", color=C.COLOR_WARN)
